...
const repo thirdPartyRepos[] = {
	...
	{ "vivaldi-broweser", QT_TRANSLATE_NOOP("thirdPartyRepos", "Vivaldi Browser"), QT_TRANSLATE_NOOP("thirdPartyRepos", "The Vivaldi browser. We strongly recommend using a free browser, such as Falkon, Chromium, Firefox or Otter instead."), "https://repo.vivaldi.com/archive/rpm/x86_64", "https://repo.vivaldi.com/archive/linux_signing_key.pub" },	
