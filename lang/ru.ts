...
<context>
    ...
    <message>
        ...
        <translation>Выбор репозиториев программного обеспечения OpenMandriva</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Репозитории OpenMandriva</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Сторонние репозитории, содержащие (обычно несвободное) программное обеспечение, где ни программное обеспечение, ни пакеты не поддерживаются командой OpenMandriva. Эти пакеты не находятся под нашим контролем, и вы будете получать обновления до того, как они будут протестированы на OpenMandriva. Используйте на свой риск.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Вы уверены, что хотите сменить источник обновлений на более медленный?</translation>
    </message>
    <message>
        <location filename="../src/UpdateChannelPicker.cpp" line="31"/>
        ...
        <translation>Вы хотите перейти на источник обновлений, который старее, чем тот, который вы сейчас используете. Это приведёт к установке более старых версий пакетов, которые могут и не работать. Возвращение к старым версиям не поддерживается (старые версии приложений не могут знать о возможных изменениях в новых версиях...) и может сломать вашу систему. Вы уверены, что хотите это сделать? </translation>
    </message>
    <message>
        <location filename="../src/UpdateChannelPicker.cpp" line="36"/>
        <source>Really upgrade?</source>
        <translation>Вы уверены, что хотите сменить источник обновлений на более быстрый?</translation>
    </message>
    <message>
        <location filename="../src/UpdateChannelPicker.cpp" line="36"/>
...
<context>
    ...
    <message>
        ...
        <translation>Unsupported содержит пакеты, которые являются бесплатными, но официально не поддерживаются OpenMandriva Lx. Хотя мы постараемся исправить их, если что-то сломается, на это низкий приоритет. Включите Unsupported, если они вам нужны, и не возражаете против возможного сбоя.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Restricted содержит пакеты, которые являются бесплатными, но обременены патентами, что может сделать их незаконными для использования или распространения в некоторых странах. Вы несете ответственность за соблюдение ваших местных законов.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Non-free содержит пакеты, которые не являются бесплатными (как в Open Source). Даже если мы захотим, мы не сможем исправить проблемы в них. Мы не можем прочитать код или проверить, что на самом деле делают пакеты. Хотя о побочных эффектах ничего не известно, они могут содержать шпионские или вредоносные программы. Они могут стереть ваш жесткий диск. Вы предоставлены сами себе.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Браузер Google Chrome. Мы настоятельно рекомендуем вместо этого использовать бесплатный браузер, такой как Falkon, Chromium, Firefox или Otter.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Браузер Microsoft Edge. Мы настоятельно рекомендуем вместо этого использовать бесплатный браузер, такой как Falkon, Chromium, Firefox или Otter.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Мессенджер Skype. Мы настоятельно рекомендуем вместо этого использовать свободный мессенджер, например Telegram.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Бета версии мессенджера Skype. Мы настоятельно рекомендуем вместо этого использовать свободный мессенджер, например Telegram.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Платформа для делового общения Microsoft Teams. Мы настоятельно рекомендуем вместо этого использовать свободную платформу, например Mattermost.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Visual Studio Code IDE. Мы настоятельно рекомендуем использовать Qt Creator, KDevelop или другие альтернативные IDE.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Всегда оставаться на этом выпуске</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Всегда оставаться на текущей стабильной версии</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Скользящий выпуск — текущие, рабочие версии</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ветка разработки — самая последняя, ​​возможны ошибки в любое время</translation>
    </message>
</context>
</TS>